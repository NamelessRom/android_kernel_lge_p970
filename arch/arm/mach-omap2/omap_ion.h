...
#define OMAP3_ION_HEAP_CARVEOUT_INPUT_SIZE       (SZ_1M * 20)			// youmi.jun@lge.com , workaround: increase size for ARTTOOL test (30MB -> 35MB) | eviscerationls@gmail.com , free 15MB RAM, set the size to 20MB
