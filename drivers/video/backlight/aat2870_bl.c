...
struct aat2870_device {
	...
	u8 brightness;
	size_t als_polling_interval_ms[ENUM_SIZE(MODE)];
...
static void set_mode(struct i2c_client *client, enum MODE mode)
{
	...
	als->polling_interval_ms = adev->als_polling_interval_ms[mode];
...
static DEV_INT_ATTR(als_polling_interval_screen_off, 0644,
	ALS_IVAL_MIN, ALS_IVAL_MAX_OFF,
	I2C_OFFSET(als_polling_interval_ms[MODE_SCREEN_OFF]), update_polling_interval);
static DEV_INT_ATTR(als_polling_interval_sensor, 0644,
	ALS_IVAL_MIN, ALS_IVAL_MAX_SENSOR,
	I2C_OFFSET(als_polling_interval_ms[MODE_SENSOR]), update_polling_interval);
static DEV_INT_ATTR(als_polling_interval_user, 0644,
	ALS_IVAL_MIN, ALS_IVAL_MAX_USER,
	I2C_OFFSET(als_polling_interval_ms[MODE_USER]), update_polling_interval);
...
static struct device_attribute *attrs[] = {
	&dev_int_attr_als_polling_interval_screen_off.attr.dev_attr,
	&dev_int_attr_als_polling_interval_screen_off.min_attr.dev_attr,
	&dev_int_attr_als_polling_interval_screen_off.max_attr.dev_attr,
	&dev_int_attr_als_polling_interval_sensor.attr.dev_attr,
	&dev_int_attr_als_polling_interval_sensor.min_attr.dev_attr,
	&dev_int_attr_als_polling_interval_sensor.max_attr.dev_attr,
	&dev_int_attr_als_polling_interval_user.attr.dev_attr,
	&dev_int_attr_als_polling_interval_user.min_attr.dev_attr,
	&dev_int_attr_als_polling_interval_user.max_attr.dev_attr,
...
static int aat2870_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	memcpy(adev->als_polling_interval_ms, default_als_polling_interval_ms,
		sizeof(adev->als_polling_interval_ms));
