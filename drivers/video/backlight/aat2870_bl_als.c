...
static KOBJ_INT_MIN_MAX_ATTR(polling_interval, 0444);
...
static struct attribute *attrs[] = {
	...
	&kobj_val_attr_polling_interval.kobj_attr.attr,
	&kobj_val_attr_polling_interval_min_max.kobj_attr.attr,
...
void als_set_poll_ival(struct als *als, int poll_ival_ms)
{
	...
	als->polling_interval_ms = poll_ival_ms;
	cancel_delayed_work(&als->update_als_level_stage1);
	schedule_delayed_work(&als->update_als_level_stage1, 0);
