...
#define fade_dbg(...) dev_dbg(fade->fade_props->parent, __VA_ARGS__)
#define fade_info(...) dev_info(fade->fade_props->parent, __VA_ARGS__)
#define fade_warn(...) dev_warn(fade->fade_props->parent, __VA_ARGS__)
#define fade_err(...) dev_err(fade->fade_props->parent, __VA_ARGS__)
